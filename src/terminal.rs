...
pub(crate) trait Output {
        ...
        Self: Sized,
    {
        ...
        match cmd {
            ...
            EnterStrikethroughMode => ti(self, b"\x1b[9m", |t| &t.enter_strikethrough_mode),
            ExitStrikethroughMode => ti(self, b"\x1b[29m", |t| &t.exit_strikethrough_mode),
...
pub struct Term {
    ...
    pub enter_strikethrough_mode: Option<CString>,
    pub exit_strikethrough_mode: Option<CString>,
...
impl Term {
    ...
    fn new(db: terminfo::Database) -> Self {
        Term {
            ...
            // TODO: according to `get_str_cap` this should panic
            enter_strikethrough_mode: get_str_cap(&db, "smxx"),
            exit_strikethrough_mode: get_str_cap(&db, "rmxx"),
